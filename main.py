...
def createlabel():
    ...
    #button
    #searchbutton
    BrowseButton= Button(mp,text='Search',bg='cyan2',font=('arial',13,'italic bold'),width=20,bd=0,
                         activebackground='purple4',command=musicurl,compound=RIGHT)
    BrowseButton.grid(row=0,column=2,padx=20,pady=20)
    #playbutton
    mp.PlayButton= Button(mp,text='Play  ',  bg='orange', font=('arial', 13, 'italic bold'), width=20, bd=0,
                          activebackground='purple4',command=playmusic,compound=RIGHT)
    mp.PlayButton.grid(row=1, column=0, padx=20, pady=20)
    #pausebutton
    mp.PauseButton = Button(mp, text='Pause  ', bg='cyan2', font=('arial', 13, 'italic bold'), width=20, bd=0,
                        activebackground='purple4',command=pause,compound=RIGHT)
    mp.PauseButton.grid(row=1, column=1, padx=20, pady=20)
    # resumebutton
    mp.ResumeButton = Button(mp, text='Resume  ', bg='orange', font=('arial', 13, 'italic bold'), width=20, bd=5,
                         activebackground='purple4', command=resume,compound=RIGHT)
    mp.ResumeButton.grid(row=1, column=1, padx=20, pady=20)
    mp.ResumeButton.grid_remove()
    #mutebutton
    mp.mutebutton=Button(mp,text='Mute  ',width=15,bg='orange',activebackground='purple',bd=5,command=mute,compound=RIGHT)
    mp.mutebutton.grid(row=3,column=3)
    mp.mutebutton.grid_remove()
    # unmutebutton
    mp.unmutebutton = Button(mp, text='Unmute  ', width=15, bg='orange', activebackground='purple', bd=5,command=unmute,compound=RIGHT)
    mp.unmutebutton.grid(row=3, column=3)
    mp.unmutebutton.grid_remove()
    #volumeup
    VolumeupButton = Button(mp, text='Volume Up ', bg='orange', font=('arial', 13, 'italic bold'), width=20, bd=5,
                        activebackground='purple4',command=volumeup,compound=RIGHT)
    VolumeupButton.grid(row=1, column=2, padx=20, pady=20)
    # stopbutton
    StopButton = Button(mp, text='Stop ', bg='orange', font=('arial', 13, 'italic bold'), width=20, bd=0,
                        activebackground='purple4',command=stop,compound=RIGHT)
    StopButton.grid(row=2, column=0, padx=20, pady=20)
    # volumedown
    VolumeDownButton = Button(mp, text='Volume Down ', bg='orange', font=('arial', 13, 'italic bold'), width=20, bd=5,
                            activebackground='purple4',command=volumedown,compound=RIGHT)
